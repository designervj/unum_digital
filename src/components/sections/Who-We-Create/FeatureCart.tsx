        ...
        <div className="bg-[#F8F8F8] rounded-2xl py-16 md:py-20 px-6 md:px-10">
            ...
            {insightsData.map((insight, index) => (
              ...
              >
                ...
                <div className="mt-auto pt-0">
                  ...
                  <a href="#" className="text-[#31AC00] italic text-md font-medium hover:underline">
                    Read Article &gt;
                  </a>
                </div>
              </div>
          ...
          <div className="text-center mt-16">
            <button
              ...
              className="bg-[#31AC00] hover:bg-[#2d9802] text-white font-medium py-3 px-8 rounded-full hover:bg-opacity-90 transition-all duration-300"
            >
              See all Article
            </button>
          </div>
