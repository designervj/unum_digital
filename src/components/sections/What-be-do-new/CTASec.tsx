      ...
      <div className="md:max-w-[80%] max-w-[100%]  mx-auto bg-gray-100 rounded-2xl text-center px-6 py-16 md:py-20">
        ...
        <div className="flex justify-center items-center gap-4 flex-wrap">
          <a href="/lets-talk#demo">
            <button className="bg-[#31AC00] hover:bg-[#2d9802] text-white px-6 py-3 rounded-full text-sm font-medium transition-all">
              Book a Free Demo
            </button>
          </a>
          <a href=" /lets-talk#ask">
            <button className="border bg-[#31AC000a] border-[#31AC004d] text-[#2f2a4a] px-6 py-3 rounded-full text-sm font-medium hover:bg-white transition-all">
              Ask Us Anything
            </button>
          </a>
        </div>
