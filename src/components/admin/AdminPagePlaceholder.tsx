  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center rounded-3xl border border-dashed border-[#d7dfdb] bg-white/50 p-12 text-center shadow-sm">
      <div className="relative mb-8">
        <div className="absolute -right-4 -top-4 animate-pulse opacity-40 text-[#31AC00]">
          <Sparkles size={32} />
        </div>
        <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-[#eaf8df] text-[#1f7a39] shadow-xl shadow-[#31AC00]/10">
      ...
      <div className="mt-12 flex items-center gap-2">
        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-[#31AC00]" style={{ animationDelay: "0ms" }} />
        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-[#31AC00]" style={{ animationDelay: "150ms" }} />
        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-[#31AC00]" style={{ animationDelay: "300ms" }} />
